...
`codevhub skill office` installs the CoDev Office skills so your agents can produce and edit real DOCX, XLSX, PPTX and PDF files. Everything ships in one offline bundle — no login and no per-skill downloads:
